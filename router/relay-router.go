...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.RequestDetailCapture(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.RequestDetailCapture())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.RequestDetailCapture(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.RequestDetailCapture())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.RequestDetailCapture(), middleware.Distribute())
	{
