	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff/info", controller.GetInvitationInfo)
				selfRoute.GET("/aff/rewards", controller.GetInvitationRewards)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/invitation", controller.GetInvitationSetting)
			optionRoute.PUT("/invitation", controller.UpdateInvitationSetting)
		...
		requestDetailRoute := apiRouter.Group("/request-detail")
		requestDetailRoute.Use(middleware.AdminAuth())
		{
			requestDetailRoute.GET("/", controller.GetRequestDetails)
			requestDetailRoute.GET("/stats", controller.GetRequestDetailStats)
			requestDetailRoute.GET("/:request_id", controller.GetRequestDetail)
		}
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.GET("/routing-config", controller.GetTokenRoutingConfig)
