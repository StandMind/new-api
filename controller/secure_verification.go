...
func UniversalVerify(c *gin.Context) {
	userId := c.GetInt("id")
	if userId == 0 {
		common.ApiErrorI18nStatus(c, http.StatusUnauthorized, i18n.MsgUnauthorized)
		return
	}
	...
	if !has2FA && !hasPasskey {
		common.ApiErrorI18n(c, i18n.MsgAuthVerificationMethodUnavailable)
		return
	}
	...
	case "2fa":
		...
		if req.Code == "" {
			common.ApiErrorI18n(c, i18n.MsgAuthVerificationCodeRequired)
			return
		}
	...
	default:
		common.ApiErrorI18n(c, i18n.MsgAuthVerificationMethodUnsupported)
		return
	}

	if !verified {
		common.ApiErrorI18n(c, i18n.MsgAuthVerificationFailed)
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": common.TranslateMessage(c, i18n.MsgAuthVerificationSuccess),
		"data": gin.H{
			"verified":   true,
