...
func Setup2FA(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": common.TranslateMessage(c, i18n.MsgTwoFASetupSuccess),
...
func Enable2FA(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": common.TranslateMessage(c, i18n.MsgTwoFAEnableSuccess),
	})
}
...
func Disable2FA(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": common.TranslateMessage(c, i18n.MsgTwoFADisableSuccess),
	})
}
...
func RegenerateBackupCodes(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": common.TranslateMessage(c, i18n.MsgTwoFABackupRegenerated),
...
func AdminDisable2FA(c *gin.Context) {
	...
	if !canManageTargetRole(myRole, targetUser.Role) {
		common.ApiErrorI18n(c, i18n.MsgTwoFAAdminPermissionDenied)
		return
	}
