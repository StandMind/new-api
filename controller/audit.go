...
var auditContentTemplates = map[string]string{
	...
	"group_model_route.update":    "Updated group model route ${group}/${model}",
	"group_model_route.delete":    "Deleted group model route ${group}/${model}",
	"openlux_price_sync.bindings": "Updated OpenLux price sync bindings (revision ${binding_revision})",
	"openlux_price_sync.apply":    "Applied ${applied_count} OpenLux price sync changes",
