...
const OPENAI_CHAT_PARAMS: SupportedParameter[] = [
  {
    name: 'model',
    type: 'string',
    required: true,
    descriptionKey: 'Model ID to route and bill the request',
  },
  {
    name: 'messages',
    type: 'array',
    required: true,
    descriptionKey: 'Conversation messages for Chat Completions',
  },
  {
    name: 'temperature',
    type: 'number',
  ...
  },
  {
    ...
    range: '>= 1',
    descriptionKey:
      'Legacy maximum visible output tokens; use max_completion_tokens for reasoning models',
  },
  {
  ...
  },
  {
    ...
    descriptionKey: 'Controls GPT-5 response verbosity when supported',
  },
  {
  ...
  },
  {
    name: 'stream_options',
    type: 'object',
    descriptionKey: 'Streaming options such as include_usage',
  },
  {
  ...
  },
  {
    ...
    type: 'boolean',
    descriptionKey: 'Allow multiple tool calls to run in parallel',
  },
  {
    name: 'logprobs',
    type: 'boolean',
  ...
  },
  {
    name: 'metadata',
    type: 'object',
    descriptionKey: 'Developer metadata attached to the request',
  },
  {
    name: 'store',
    type: 'boolean',
    descriptionKey:
      'Allow upstream retention when the channel permits this parameter',
  },
]

const OPENAI_RESPONSES_PARAMS: SupportedParameter[] = [
  {
    name: 'model',
    type: 'string',
    required: true,
  ...
  },
  {
    ...
    type: 'string',
    required: true,
    descriptionKey: 'Input text, messages, or multimodal content for Responses',
  },
  {
    name: 'instructions',
    type: 'string',
    descriptionKey: 'System or developer instructions for the response',
  },
  {
    name: 'max_output_tokens',
    type: 'integer',
    range: '>= 1',
    descriptionKey: 'Maximum output tokens generated by the model',
  },
  {
    name: 'reasoning',
    type: 'object',
    descriptionKey: 'Responses API reasoning controls such as effort',
  },
  {
    name: 'text',
    type: 'object',
    descriptionKey: 'Text output controls such as format',
  },
  {
    name: 'stream',
    type: 'boolean',
  ...
  },
  {
    ...
    type: 'string',
    descriptionKey: 'Previous response ID for stateful follow-up calls',
  },
  {
    name: 'temperature',
    type: 'number',
...
const ANTHROPIC_MESSAGES_PARAMS: SupportedParameter[] = [
  {
    name: 'model',
    type: 'string',
    required: true,
  ...
  },
  {
    ...
    type: 'array',
    required: true,
    descriptionKey: 'Conversation messages for Anthropic Messages',
  },
  {
    name: 'max_tokens',
    type: 'integer',
  ...
  },
  {
    name: 'system',
    type: 'string',
    descriptionKey: 'System prompt for Anthropic Messages',
  },
  {
    name: 'temperature',
    type: 'number',
  ...
  },
  {
    ...
    type: 'integer',
    range: '>= 0',
    descriptionKey: 'Limit sampling to the top K token candidates',
  },
  {
    name: 'stop_sequences',
    type: 'array',
    descriptionKey: 'Strings that stop model generation',
  },
  {
    name: 'stream',
    type: 'boolean',
...
const GEMINI_GENERATE_CONTENT_PARAMS: SupportedParameter[] = [
  {
    name: 'contents',
    type: 'array',
    required: true,
    descriptionKey: 'Conversation content parts sent to Gemini',
  },
  {
    name: 'systemInstruction',
    type: 'object',
    descriptionKey: 'System-level instruction for Gemini',
  },
  {
    name: 'generationConfig',
    type: 'object',
    descriptionKey: 'Container for Gemini generation controls',
  },
  {
  ...
  },
  {
    ...
    type: 'integer',
    range: '>= 1',
    descriptionKey: 'Maximum output tokens generated by Gemini',
  },
  {
    name: 'generationConfig.candidateCount',
    type: 'integer',
    range: '>= 1',
    descriptionKey: 'Number of response candidates to generate',
  },
  {
    name: 'generationConfig.stopSequences',
    type: 'array',
    descriptionKey: 'Strings that stop Gemini generation',
  },
  {
    name: 'generationConfig.responseMimeType',
    type: 'string',
    descriptionKey: 'Requested response MIME type such as application/json',
  },
  {
    name: 'generationConfig.responseSchema',
    type: 'object',
    descriptionKey: 'Schema for structured JSON responses',
  },
  {
    name: 'generationConfig.responseJsonSchema',
    type: 'object',
    descriptionKey: 'JSON schema for structured responses',
  },
  {
  ...
  },
  {
    ...
    type: 'boolean',
    descriptionKey: 'Return response log probability data',
  },
  {
  ...
  },
  {
    ...
    type: 'array',
    descriptionKey: 'Requested output modalities',
  },
  {
    name: 'generationConfig.thinkingConfig',
    type: 'object',
    descriptionKey: 'Gemini thinking budget and thought visibility controls',
  },
  {
    name: 'generationConfig.speechConfig',
    type: 'object',
    descriptionKey: 'Speech output configuration',
  },
  {
    name: 'generationConfig.imageConfig',
    type: 'object',
    descriptionKey: 'Image generation configuration',
  },
  {
    name: 'safetySettings',
    type: 'array',
    descriptionKey: 'Per-category safety thresholds',
  },
  {
    name: 'tools',
    type: 'array',
    descriptionKey:
      'Gemini tool declarations such as functions, search, or code execution',
  },
  {
    name: 'toolConfig',
    type: 'object',
    descriptionKey: 'Tool execution policy and retrieval configuration',
  },
  {
    name: 'cachedContent',
    type: 'string',
    descriptionKey: 'Cached content resource name to reuse context',
  },
]
