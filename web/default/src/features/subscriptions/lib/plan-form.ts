...
export function planToFormValues(plan: SubscriptionPlan): PlanFormValues {
  return {
    ...
    upgrade_user_level: plan.upgrade_user_level || '',
    downgrade_user_level: plan.downgrade_user_level || '',
    stripe_price_id: plan.stripe_price_id || '',
    creem_product_id: plan.creem_product_id || '',
    creem_test_product_id: plan.creem_test_product_id || '',
...
export function formValuesToPlanPayload(values: PlanFormValues): PlanPayload {
  return {
    plan: {
      ...
      upgrade_user_level: values.upgrade_user_level || '',
      downgrade_user_level: values.downgrade_user_level || '',
    },
  }
}
