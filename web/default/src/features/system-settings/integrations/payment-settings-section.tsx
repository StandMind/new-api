...
export function PaymentSettingsSection({
  ...
  const form = useForm<PaymentFormValues>({
    ...
    defaultValues: {
      ...
      CreemTestProducts: formatJsonForEditor(
        initialFormValues.CreemTestProducts
      ),
    },
  })
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        {t(
                          'Configure live Creem products. Provide a JSON array.'
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          {t(
                            'Creem test API key (leave blank unless updating)'
                          )}
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        {t(
                          'Configure test Creem products. Provide a JSON array.'
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
