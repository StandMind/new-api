...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&Ability{},
		&GroupModelRoute{},
		&OpenLuxPriceSyncBinding{},
		&OpenLuxPriceSyncState{},
		&Log{},
		&RequestDetail{},
		&Midjourney{},
		&TopUp{},
	...
	if err := MigrateLegacyTokenGroupChains(); err != nil {
		return err
	}
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&OpenLuxPriceSyncBinding{}, "OpenLuxPriceSyncBinding"},
		{&OpenLuxPriceSyncState{}, "OpenLuxPriceSyncState"},
		{&Log{}, "Log"},
		{&RequestDetail{}, "RequestDetail"},
		{&Midjourney{}, "Midjourney"},
		{&TopUp{}, "TopUp"},
		{&InvitationTopupReward{}, "InvitationTopupReward"},
		{&QuotaData{}, "QuotaData"},
		{&Task{}, "Task"},
		{&Model{}, "Model"},
		{&Vendor{}, "Vendor"},
...
` + "`creem_test_product_id`" + ` varchar(128) DEFAULT '',
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "creem_test_product_id", DDL: "`creem_test_product_id` varchar(128) DEFAULT ''"},
