...
func handleHTTPPanic(c *gin.Context, recovered any) {
	common.SysLog("panic detected: " + common.MaskSensitiveInfo(fmt.Sprint(recovered)))
...
func run() error {
	...
	server := gin.New()
	server.Use(gin.CustomRecovery(handleHTTPPanic))
